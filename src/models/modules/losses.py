...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, in_dim=3, ndf=64, n_layers=3, use_actnorm=False):
        ...
        padw = 1
        sequence = [
            nn.Conv2d(in_dim, ndf, kernel_size=kw, stride=2, padding=padw),
...
class LPIPSWithDiscriminator(nn.Module):
    def __init__(
        ...
        self.discriminator = NLayerDiscriminator(
            in_dim=disc_in_channels, n_layers=disc_num_layers, use_actnorm=use_actnorm
        ).apply(weights_init)
